...
window.MicroModal = _micromodal["default"];
window.Cleave = _cleave["default"];
window.AOS = _aos["default"];

require("./user.js");

},{"./user.js":2,"aos":3,"cleave.js":5,"cleave.js/dist/addons/cleave-phone.ru":4,"micromodal":6,"swiper":7}],2:[function(require,module,exports){
"use strict";
...
window.onload = function () {
  ...
  AOS.init({
    duration: 800,
    offset: !window.matchMedia("(max-width: 768px)").matches ? 120 : 50
  }); // DropDown function

  (function () {
    document.querySelectorAll("a[data-drop-link]").forEach(function (item, index) {
      item.addEventListener("click", function (e) {
        e.preventDefault();
        var targetData = e.target.dataset.dropLink;
        var target = document.querySelector("[data-drop-target=".concat(targetData, "]"));
  ...
  (function () {
    document.querySelectorAll("[data-swiper]").forEach(function (item, index) {
      var options = JSON.parse(item.dataset.swiper);
      options.navigation = {
      ...
      options.initialSlide = Math.floor(slides.length / 2);
      var swiper = new Swiper(item, options);
      swiper.on("slideChangeTransitionStart", function () {
        this.wrapperEl.querySelectorAll(".swiper-slide").forEach(function (item) {
          item.classList.remove("swiper-slide-prev_pre");
          item.classList.remove("swiper-slide-next_pre");
        });
        var prev = this.wrapperEl.querySelector(".swiper-slide-prev");
        var next = this.wrapperEl.querySelector(".swiper-slide-next");

        if (prev && prev.previousElementSibling) {
          prev.previousElementSibling.classList.add("swiper-slide-prev_pre");
        }

        if (next && next.nextElementSibling) {
          next.nextElementSibling.classList.add("swiper-slide-next_pre");
        }
      });
      ...
      if (window.matchMedia("(max-width: 768px)").matches && item.dataset.swiperMobile === "false") {
        return false;
      } else {
        swiper.init();
      }
  ...
  (function () {
    document.querySelectorAll("[data-tab]").forEach(function (item) {
      var headerLinks = item.querySelectorAll("[data-tab-link]");
      var contentTabs = item.querySelectorAll("[data-tab-content]");
      headerLinks.forEach(function (link) {
        link.addEventListener("click", function (e) {
          e.preventDefault();
          var num = this.dataset.tabLink;
          headerLinks.forEach(function (_link) {
            _link.setAttribute("aria-disabled", true);
          });
          e.target.setAttribute("aria-disabled", false);
          contentTabs.forEach(function (content) {
            content.setAttribute("aria-hidden", true);

            if (content.dataset.tabContent == num) {
  ...
  (function () {
    var phoneMask = new Cleave('input[data-type="tel"]', {
      phone: true,
      phoneRegionCode: "RU"
    });
  })();
...
!function () {
  ...
  function p(n, l) {
    for (var t = o(n.j()), e = 0; e < t.length; e++) {
      ...
      if (null != l.a[u]) {
        n.b && delete n.b[r.b];
        var i = 11 == r.a || 10 == r.a;
        if (r.g) for (var r = c(l, u) || [], a = 0; a < r.length; a++) {
          var s = n,
              f = u,
              h = i ? r[a].clone() : r[a];
  ...
  function g(n, l) {
    var t;
    if (null != n.a[l]) t = h(n, l, void 0);else n: {
      if (t = n.f[l], void 0 === t.f) {
        var e = t.i;
        if (e === Boolean) t.f = !1;else if (e === Number) t.f = 0;else {
          if (e !== String) {
            t = new e();
            break n;
          }
  ...
  return (
    ...
    function (module, exports, __webpack_require__) {
      ...
      (function (global) {
        ...
        Cleave.DefaultProperties = __webpack_require__(7); // for angular directive

        (_typeof(global) === 'object' && global ? global : window)['Cleave'] = Cleave; // CommonJS
      ...
      (function (global) {
        ...
        var DefaultProperties = {
          ...
          assign: function assign(target, opts) {
            ...
            target.root = _typeof(global) === 'object' && global ? global : window;
...
},{}]},{},[1])//# sourceMappingURL=script.min.js.map
